...
# snippet-start:[python.example_code.kinesis-analytics-v2.helper_update_details]
    def _update_details(self, details):
        ...
        self.status = details['ApplicationStatus']
# snippet-end:[python.example_code.kinesis-analytics-v2.helper_update_details]
    ...
    def create(self, app_name, role_arn, env='SQL-1_0'):
        ...
        try:
            ...
            details = response['ApplicationSummary']
    ...
    def add_input(self, input_prefix, stream_arn, role_arn, input_schema):
        """
    ...
    def add_output(self, in_app_stream_name, output_arn, role_arn):
        """
        ...
        try:
            response = self.analytics_client.add_application_output(
                ...
                Output={
                    ...
                    'KinesisStreamsOutput': {'ResourceARN': output_arn, 'RoleARN':role_arn},
                    'DestinationSchema': {'RecordFormatType': 'JSON'}})
            logging.info(
                "Added output %s to %s.", output_arn, self.name)
        except ClientError:
    ...
    def update_code(self, code):
        ...
        try:
            response = self.analytics_client.update_application(
                ApplicationName=self.name,
                CurrentApplicationVersionId=self.version_id,
                ApplicationUpdate={'ApplicationCodeUpdate': code})
